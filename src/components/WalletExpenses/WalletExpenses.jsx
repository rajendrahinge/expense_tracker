    ...
    <div className="wallet-container glassmorphism">
      <div className="wallet-income-expense-container">
        <div className="wallet-card-container glassmorphism">
          <h2>
            Wallet Balance:{" "}
            <span className="cardTextGreen"> ₹{walletBalance} </span>
          </h2>
          <button
            className="gradientGreen largeButton Button"
        ...
        <div className="wallet-card-container glassmorphism">
          <h2>
            Expenses:{" "}
            <span className="cardTextRed"> ₹{getTotalExpenses()} </span>
          </h2>
          <button
            className="gradientRed largeButton Button"
      ...
      >
        ...
        <form className="modal-form-income" onSubmit={addIncome}>
          ...
          />
          <div>
            <button className="glassmorphismButton backgroundOrange" type="submit">
              Add Income
            </button>
            <button
              className="glassmorphismButton"
